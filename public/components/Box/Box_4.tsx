            ...
            <Box>
                <TableContainer mt={10}>
                    <Table variant='simple'>
                        ...
                        <Tbody>
                            {
                                showData.filter((d: dataProps) => 
                                d?.enterprise_name?.toLowerCase()?.includes(value)
                                ||
                                d?.name?.toLowerCase()?.includes(value)
                                ||
                                d?.institution?.toLowerCase()?.includes(value)
                                || 
                                d?.status?.toLowerCase()?.includes(value)
